...
List<LSServiceModel> getTopServiceList() {
  ...
  list.add(LSServiceModel(title: 'Restaurants', img: Restaurant));
  list.add(LSServiceModel(title: 'Coffee & Tea', img: Coffee));
  list.add(LSServiceModel(title: 'Dry Clean', img: LSSuit));
  list.add(LSServiceModel(title: 'Shopping', img: Shopping));
...
list.add(LSServiceModel(title: 'Baton Rouge', rating: '4.2', location: 'GEC Circle, Chittagong', img: LSList1));
list.add(LSServiceModel(title: 'Pasta Roma', rating: '4.3', location: 'M M Ali Road, Chittagong', img: LSList2));
list.add(LSServiceModel(title: 'Panshi Restaurant', rating: '4.1', location: 'GEC Circle, Chittagong', img: LSList3));
list.add(LSServiceModel(title: 'Koyla Restaurant', rating: '4.5', location: 'Nasirabad, Chittagong', img: LSList4));
list.add(LSServiceModel(title: 'Kareem\'s Restaurant', rating: '4.0', location: 'Jamalkhan, Chittagong', img: LSList1));
list.add(LSServiceModel(title: 'Bella Italia', rating: '4.6', location: 'CDA Avenue, Chittagong', img: LSList2));
list.add(LSServiceModel(title: 'Mezetto Restaurant', rating: '4.4', location: 'Chawk Bazar, Chittagong', img: LSList3));
list.add(LSServiceModel(title: 'Burgers N Beyond', rating: '4.2', location: 'Chandgaon, Chittagong', img: LSList4));
...
List<LSServiceModel> gwtPriceList() {
  ...
  list.add(LSServiceModel(title: 'Sweatshirt', amount: '10', location: '1810,Camino Real ,New-york', img: Coffee));
...
List<LSServiceModel> getOfferList() {
  ...
  list.add(LSServiceModel(title: 'For a Limited time', rating: '5', subTitle: 'Get 50% off', img: Coffee));
  list.add(LSServiceModel(title: 'For a Limited time', rating: '4.5', subTitle: 'Get 50% off', img: LSWashService));
  list.add(LSServiceModel(title: 'For a Limited time', rating: '2', subTitle: 'Get 50% off', img: Coffee));
  list.add(LSServiceModel(title: 'For a Limited time', rating: '3', subTitle: 'Get 50% off', img: Shopping));
  list.add(LSServiceModel(title: 'For a Limited time', rating: '5', subTitle: 'Get 50% off', img: Restaurant));
  list.add(LSServiceModel(title: 'For a Limited time', rating: '4.5', subTitle: 'Get 50% off', img: LSWashService));
  list.add(LSServiceModel(title: 'For a Limited time', rating: '2', subTitle: 'Get 50% off', img: Coffee));
  list.add(LSServiceModel(title: 'For a Limited time', rating: '3', subTitle: 'Get 50% off', img: Shopping));
  return list;
